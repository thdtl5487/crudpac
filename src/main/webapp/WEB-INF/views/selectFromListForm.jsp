...
<body>
	...
	<div class="container card shadow-sm">
		...
		<!-- 버튼 폼 시작 -->
		<div class="form_btn" style="display: flex; justify-content: space-between;">
			...
			<form action="/article/updateFromList.do">
				...
				<input class="btn btn-outline-secondary" id="btn_form_sex" type="submit" value="수정하기">
			</form>
			<form action="delete.do" method="post">
				...
				<input type="hidden" name="content" value="${ARTICLE_ID.content}"/>
				<input type="hidden" name="video" value="${ARTICLE_ID.video}"/>
				<input class="btn btn-danger" id="btn_form_sex" type="submit" value="삭제하기">
			</form>
		</div>
		<!-- 버튼 폼 종료 -->
